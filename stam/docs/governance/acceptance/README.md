...
|------|-----------|
| L4 핵심 | 필수 저장 |
| L3 중요 | 필수 저장 (공통 컴포넌트는 기본 L3 이상) |
| L2 일반 | 권장 저장 |
| L1 경미 | PR 체크리스트로 대체 가능 |

> 공통 컴포넌트(Picker, Dialog, Alert, Empty State 등)는 기본 L3 이상으로 분류되므로 필수 저장 대상이다. L2에 해당하지 않는다. 등급 기준은 `../STAM-AI-Verification-Protocol-v1.md` §4 참고.
