...
(function () {
  ...
  var ICON_EDIT = '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>';
    ...
    if (mode === 'detail') {
      foot.innerHTML =
        ...
        '<div class="stam-dw-foot-right">' +
          ...
          '<button class="stam-btn stam-btn-primary stam-btn--md" id="msv2-edit-btn" type="button">' + ICON_EDIT + ' 수정</button>' +
        '</div>';
