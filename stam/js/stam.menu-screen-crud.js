...
(function () {
  ...
  function setHeader(rec, mode) {
    ...
    var metaHtml = rec
      ? '<span class="stam-drawer-meta-source">' + esc(sourceKo(rec)) + '</span>'
      : '';
    ...
    head.innerHTML =
      ...
      '<div class="stam-drawer-meta">' + metaHtml + '</div>' +
      noticeHtml;
    ...
    if (mode === 'detail') {
      foot.innerHTML =
        ...
        '<div class="stam-dw-foot-right">' +
          '<button class="stam-btn stam-btn-danger-ghost" id="msv2-del-btn"  type="button">삭제</button>' +
