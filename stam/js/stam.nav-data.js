...
(function () {
  ...
  var menus = [
    ...
    { id:'C8', g:'C', n:'오픈 시나리오',        s:'오픈 시나리오 목록',     colStr:'시나리오 ID,오픈 단계,시나리오명,대상 시스템,담당자,고객 확인자,예정일시,소요시간,준비 상태,리스크,롤백 여부,Go/No-Go,최종 확인일', cols:13, phase:2, href:'pages/boards/open-scenario.html' },
    /* D — 협업/검토/승인 (8) */
