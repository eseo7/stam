...
(function () {
  ...
  var menus = [
    ...
    /* B — 산출물 관리 (12) */
    { id:'B1',  g:'B', n:'요구사항정의서',       s:'요구사항 목록',         colStr:'요구사항 ID,제목,구분,우선순위,상태,담당자,관련 화면,승인 상태',                   cols:8,  phase:1, tier:1, href:'docs/STAM-Requirement-Board-UX-Preview-v1.html' }, // TODO: replace with pages/boards/requirements.html after product page implementation
