...
| **A3** | Requirements write rules + CRUD UI | emulator syntax |
...
**현재 상태 (main @ `b23024f` + PR #357):** Google Auth + users bootstrap + membership gate + project list read + **프로젝트 생성 write**. members update/delete · 산출물 write는 **미개방**.
