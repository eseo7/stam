...
| **A3c** | Requirements CRUD live/browser QA evidence (PR #363) | contract 7종 PASS + Chromium harness PASS; **maintainer live Firestore persistence 미완료 → PR #364 Draft** — `docs/reports/STAM_PR363_Requirements_CRUD_Live_QA.md` §10 |
