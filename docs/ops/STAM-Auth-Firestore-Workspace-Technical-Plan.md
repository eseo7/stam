...
| **A3b** | Requirements CRUD UI wiring | service contract + UI |
...
**현재 상태 (main @ `b37665f` + PR #358):** Google Auth + users bootstrap + membership gate + project list read + 프로젝트 생성 write + **requirements role-scoped create/update**. members update/delete · requirement delete · 기타 산출물 write는 **미개방**.
